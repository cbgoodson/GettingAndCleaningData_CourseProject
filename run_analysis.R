...
##
## change the activity ids in y_train and y_test into factors with the activity descriptions
##
...
##
names(subset_data) <- c(names(subset_data[1:2]), features$desc[mean_std_features])
